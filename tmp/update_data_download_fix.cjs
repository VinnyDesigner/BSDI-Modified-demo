...
if (tabStart !== -1) {
    ...
    console.log('tableStart rel:', tableStart);
    console.log('tableEnd rel:', tableEnd);
    
    if (tableStart !== -1 && tableEnd !== -1) {
        const absStart = tabStart + tableStart;
        const absEnd = tabStart + tableEnd;
        
        console.log('Replacing from', absStart, 'to', absEnd);
        console.log('Original content starts with:', content.substring(absStart, absStart + 50));
        console.log('Original content ends with:', content.substring(absEnd - 50, absEnd));
        ...
        console.log('✅ Replacement applied and saved.');
    } else {
        console.log('❌ Could not locate table block inside data-download.');
    }
}
